Module funciones
    ...
    Sub ConsultasDFactf151()
        Try
            ...
            Do While Not strDFact.EOF
                ...
                '  strcontProy = strDFact.Fields("Nro").Value
                '' f15.tbxMtoCheq.Text = decimales(Math.Round(strDFact.Fields("pro_montoCheque").Value, 2))
                Exit Do
                strDFact.MoveNext()
            Loop
    ...
    Sub ConsultasDAdf7()
        Try
            ...
            strAd = cntSQL.Execute("select  sum(pro_monto)as pro_monto from [tab_AdendasProy] where pro_idProyecto=" & stridProy & " and pro_nroContrato='" & ContNro & "'")

            Do While Not strAd.EOF

                ' f7.tbxAdendas.Text = decimales(iif(strAd.Fields("pro_monto").Value dbnull.Value,0,strAd.Fields("pro_monto").Value))
            ...
            intMonAd = f7.txtMonto.Text
            intMonAd1 = f7.tbxAdendas.Text


            f7.tbxMtoAd.Text = decimales(intMonAd + intMonAd1)
    ...
    Sub insertaDatosComplProyf1()
        ...
        Try
            ...
            If ContNro = "" Then
                ...
                If strPpal.EOF = False Then
                    'cntSQL.Execute("UPDATE tab_DatosPpalProy_Compl SET pro_nroProyecto='" & f1.tbxCodp.Text & "', " _
                    '                & " pro_nroContrato='" & f1.tbxNroCon.Text & "', " _
                    '                & " pro_nroCuenta=" & CtaNro & ", " _
                    '                & " pro_serieCuenta='" & f1.txtCuenta.Text & "', " _
                    '                & " pro_FechaD='" & Format(f1.dtpFd.Value, "yyyyMMdd") & "', " _
                    '                & " pro_FechaH='" & Format(f1.dtpFH.Value, "yyyyMMdd") & "', " _
                    '                & " pro_TrabajoR=" & Replace(IIf(f1.tbxTraR.Text = "", 0, f1.tbxTraR.Text), ",", "") & ", " _
                    '                & " pro_FechaR='" & Format(f1.dtpFechaR.Value, "yyyyMMdd") & "', " _
                    '                & " pro_PresInsp= " & Replace(IIf(f1.txtInsp.Text = "", 0, f1.txtInsp.Text), ",", "") & ", " _
                    '                & " pro_FechaP='" & Format(f1.dtpPIns.Value, "yyyyMMdd") & "', " _
                    '                & " pro_periodoCuenta=" & guardacmbperPagCtas(f1.cmbperPagCtas.SelectedItem) & ", " _
                    '                & " pro_duracionProy=" & Replace(IIf(f1.txtDur.Text = "", 0, f1.txtDur.Text), ",", "") & ", " _
                    '                & " pro_FechaInicio ='" & Format(f1.dtpPIns.Value, "yyyyMMdd") & "', " _
                    '                & " pro_FechaFinOrig ='" & Format(f1.dtpFfOp.Value, "yyyyMMdd") & "', " _
                    '                & " pro_status='" & guardaComboStatus(f1.cmbxSta.SelectedItem) & "', " _
                    '                & " pro_tipo='" & guardaComboTipo(f1.cmbTipo.SelectedItem) & "' " _
        ...
        Catch ex As Exception
            MsgBox("Error en funcion insertaDatosComplProy()" & ex.Message, MsgBoxStyle.Critical, "Control Proyectos")
            swguar = 1
        End Try
    End Sub
            ...
            If ContNro = "" Then
                ...
                If strPpal.EOF = False Then
                    cntSQL.Execute("UPDATE tab_DatosPpalProy_Compl SET pro_nroProyecto='" & f7.tbxCodp.Text & "', " _
                                    ...
                                    & " pro_nroCuenta='" & CtaNro & "', " _
                                    & " pro_serieCuenta='" & f7.txtCuenta.Text & "', " _
                                    & " pro_FechaD='" & Format(f7.dtpFd.Value, "yyyyMMdd") & "', " _
                                    & " pro_FechaH='" & Format(f7.dtpFH.Value, "yyyyMMdd") & "', " _
                                    & " pro_TrabajoR=" & Replace(IIf(f7.tbxTraR.Text = "", 0, f7.tbxTraR.Text), ",", "") & ", " _
                                    & " pro_FechaR='" & Format(f7.dtpFechaR.Value, "yyyyMMdd") & "', " _
                                    & " pro_PresInsp= " & Replace(IIf(f7.txtInsp.Text = "", 0, f7.txtInsp.Text), ",", "") & ", " _
                                    & " pro_FechaP='" & Format(f7.dtpPIns.Value, "yyyyMMdd") & "', " _
                                    & " pro_periodoCuenta=" & guardacmbperPagCtas(f7.cmbperPagCtas.SelectedItem) & ", " _
                                    & " pro_duracionProy=" & Replace(IIf(f7.txtDur.Text = "", 0, f7.txtDur.Text), ",", "") & ", " _
                                    & " pro_FechaInicio ='" & Format(f7.dtpPIns.Value, "yyyyMMdd") & "', " _
                                    & " pro_FechaFinOrig ='" & Format(f7.dtpFfOp.Value, "yyyyMMdd") & "', " _
                                    & " pro_status='" & guardaComboStatus(f7.cmbxSta.SelectedItem) & "', " _
                                    & " pro_tipo='" & guardaComboTipo(f7.cmbTipo.SelectedItem) & "' " _
                                    & " where pro_idProyecto=" & stridProy & " and pro_nroCuenta='" & CtaNro & "'")
                ...
                Else
                    ...
                    cntSQL.Execute("insert into tab_DatosPpalProy_Compl (pro_idProyecto,pro_nroProyecto,pro_nroContrato," _
                                 & " pro_nroCuenta,pro_serieCuenta, pro_FechaD,pro_FechaH,pro_TrabajoR,pro_FechaR,pro_PresInsp,pro_FechaP,pro_periodoCuenta," _
                                    & " pro_duracionProy, pro_FechaInicio, pro_FechaFinOrig, pro_status, pro_tipo,pro_NroFactura) values (  '" & id & "', " _
                                       & " '" & f7.tbxCodp.Text & "', " _
                                       & " '" & f7.tbxNroCon.Text & "', " _
                                       & " '" & CtaNro & "', " _
                                       & " '" & f7.txtCuenta.Text & "', " _
                                       & " '" & Format(f7.dtpFd.Value, "yyyyMMdd") & "', " _
                                       & " '" & Format(f7.dtpFH.Value, "yyyyMMdd") & "', " _
                                       & "  " & Replace(IIf(f7.tbxTraR.Text = "", 0, f7.tbxTraR.Text), ",", "") & ", " _
                                       & " '" & Format(f7.dtpFechaR.Value, "yyyyMMdd") & "', " _
                                       & "  " & Replace(IIf(f7.txtInsp.Text = "", 0, f7.txtInsp.Text), ",", "") & ", " _
                                       & " '" & Format(f7.dtpPIns.Value, "yyyyMMdd") & "', " _
                                       & " " & guardacmbperPagCtas(f7.cmbperPagCtas.SelectedItem) & ", " _
                                       & " '" & f7.txtDur.Text & "', " _
                                       & " '" & Format(f7.dtpFechai.Value, "yyyyMMdd") & "', " _
                                       & " '" & Format(f7.dtpFfOp.Value, "yyyyMMdd") & "', " _
                                       & " '" & guardaComboStatus(f7.cmbxSta.SelectedItem) & "', " _
                                       & " '" & guardaComboTipo(f7.cmbTipo.SelectedItem) & "', " _
                                       & " '')")
    ...
    Sub clearDcompl()
        ...
        f7.cmbperPagCtas.SelectedIndex = -1
        f7.txtDur.Text = ""
        'f7.tbxAdendas.Text = ""
        'f7.tbxMtoAd.Text = ""

        f7.cmbxSta.SelectedIndex = -1
        f7.cmbTipo.SelectedIndex = -1
        'End If
    ...
    Sub clearDPpal15()
        ...
        'f15.cmbxSta.SelectedIndex = -1
        'f15.cmbTipo.SelectedIndex = -1
        '' End If
    ...
    Sub guardaActDPpalProy()
        ...
        Try
            ...
            If ContNro = "" Then
                ...
                If strPpal.EOF = False Then
                    cntSQL.Execute("UPDATE tab_DatosPpalProy SET pro_nroProyecto='" & f1.tbxCodp.Text & "', " _
                                    & " pro_nroContrato='" & f1.tbxNroCon.Text & "', " _
                                    & " pro_descripcion='" & f1.tbxDescr.Text & "', " _
                                    & " pro_Sector= '" & guardaComboSector(f1.cmbClas.SelectedItem) & "', " _
                                    & " pro_Provincia='" & f1.tbxUbi.Text & "', " _
                                    & " pro_monto=" & Replace(IIf(f1.txtMonto.Text = "", 0, f1.txtMonto.Text), ",", "") & " " _
                                    & " where pro_idProyecto=" & stridProy & "")
                ...
                Else
                    ...
                    id = idProyecto(id)
                    ConexionSQL()
                    cntSQL.Execute("insert into tab_DatosPpalProy (pro_idProyecto,	pro_nroProyecto,pro_descripcion,pro_Sector,pro_nroContrato,pro_Provincia,pro_monto) values (  '" & id & "', " _
                                       & " '" & f1.tbxCodp.Text & "', " _
                                       & " '" & f1.tbxDescr.Text & "', " _
                                       & " '" & guardaComboSector(f1.cmbClas.SelectedItem) & "', " _
                                       & " '" & f1.tbxNroCon.Text & "', " _
                                       & " '" & f1.tbxUbi.Text & "', " _
                                       & "  " & Replace(IIf(f1.txtMonto.Text = "", 0, f1.txtMonto.Text), ",", "") & ")")
            ...
            If ContNro = "" Then
                ...
                Else
                    ...
                    cntSQL.Execute("insert into tab_DatosPpalProy (pro_idProyecto,	pro_nroProyecto,pro_descripcion,pro_Sector,pro_nroContrato,pro_Provincia,pro_monto) values (  '" & id & "', " _
                                       ...
                                       & " '" & f7.tbxNroCon.Text & "', " _
                                       & " '" & f7.tbxUbi.Text & "', " _
                                       & "  " & Replace(IIf(f7.txtMonto.Text = "", 0, f7.txtMonto.Text), ",", "") & ")")
        ...
        Try
            ...
            Do While Not strPpal.EOF
                ...
                If swRec = 0 Then
                    ...
                    'f7.cmbperPagCtas.SelectedIndex = IIf(strPpal.Fields("pro_periodoCuenta").Value Is DBNull.Value, 0, strPpal.Fields("pro_periodoCuenta").Value)
                    ...
                    'f7.cmbxSta.SelectedIndex = IIf(strPpal.Fields("pro_status").Value = "", 0, strPpal.Fields("pro_status").Value)
                    'guardaComboTipo(f7.cmbTipo.SelectedItem)  = IIf(strPpal.Fields("pro_tipo").Value = "", 0, strPpal.Fields("pro_tipo").Value)
