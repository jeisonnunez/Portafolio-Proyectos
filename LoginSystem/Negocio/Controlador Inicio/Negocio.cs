    ...
    public class Negocios:Base
    {
        ...
        public bool VerificaDebeHaber(DataTable dt)
        {
            ...
            if (sw == true)
            {
                ...
                else if (SysDeb > SysCred)
                {
                    if ((SysDeb - 0.01m) == SysCred)
                    {
                        sw = true;
                ...
                if (sw == true)
                {
                    ...
                    else if (FCDebit > FCCredit)
                    {
                        if ((FCDebit - 0.01m) == FCCredit)
                        {
                            sw = true;
