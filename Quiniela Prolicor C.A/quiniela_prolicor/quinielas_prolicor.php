...
.button2{
  ...
  -webkit-box-shadow: 0 3px #1A1B41; 
  -moz-box-shadow: 0 3px #1A1B41; 
  box-shadow: 0 3px #1A1B41;
  transition: all 0.1s linear 0s; 
  top: 0px;
  position: relative;
}
...
if(isset($_POST["seleccion"]) || (isset($_POST["actualizar"]))){

?>

 <p class='usuario'>Usuario: <?php echo $_SESSION["usuario"] ?> </p><br><p class='usuario'>Codigo_Quiniela: <?php echo $_POST["seleccion"] ?></p>
 
<?php 
}else{
?>

<p class='usuario'>Usuario: <?php echo $_SESSION["usuario"] ?> </p><br>
...
function comprobar(){
	...
	$fecha_cierre="2018-06-14 09:00:00";
...
//--------------------------------------------------------Evento al presionar crear nueva quiniela--------------------------------					
					
if(isset($_POST["crear"])){
	
//----------------------------------------------------------------cuenta cantidad de quinielas del usuario---------------------------	

$cuenta_quiniela=$base->prepare("select count(cedula) as cuenta from usuarios_quiniela where cedula='$_usuario'");

$cuenta_quiniela->execute(array());

$cuenta_quiniela_array = $cuenta_quiniela->fetchAll();
				
					foreach ($cuenta_quiniela_array as $row1) {
						
						$cantidad_de_quinielas=$row1["cuenta"];
					}
	
	//----------------------------------------------------------------crea quiniela al usuario-------------------------------------
	
	if($cantidad_de_quinielas<3){
	
		$sql="insert into usuarios_quiniela (cedula) values ('$_usuario')";
		...
		?>	
			<script language='javascript'> 			
							...
							window.location.replace('quinielas_prolicor.php');
						 </script>
		<?php
		...
		?>
			...
			<?php		 
//----------------------------------------------------------identifica el codigo de quiniela actual del usuario----------------------
					 
					$sql_total = $base->prepare("select max(codigo_quiniela) as Cod from usuarios_quiniela where cedula='$_usuario'");
					$sql_total->execute(array());
					$quiniela_actual = $sql_total->fetchAll();
				
					foreach ($quiniela_actual as $row1) {
						$quiniela_usuario=$row1["Cod"];
						$_SESSION["quiniela_actual"]=$quiniela_usuario;
					
					    $q_actual=$_SESSION["quiniela_actual"];
					}
					
					
					
//-----------------------------------------------------------duplica plantilla en la quiniela actual del usuario-----------------
					
					$sql_final=$base->prepare("insert into quinielas select '$quiniela_usuario', posicion, valor_1, valor_2, grupo,  equipo_1, equipo_2, fecha_partido from plantilla_quiniela");
					$sql_final->execute();
					
//-----------------------------------------------------------------copia los datos de la plantilla quiniela----------------------------
						...
						$valores=$base->prepare("select valor_1, valor_2 from quinielas where codigo_quiniela='$quiniela_usuario' and posicion='$con'");
				...
				?>	
					<script language='javascript'> 			
						...
						alert('Quiniela Creada Correctamente');
						window.location.replace('quinielas_prolicor.php');
	...
	}//end if cantidad quiniela
	else
	{
?>			
	<script language='javascript'> 				
	alert('Error. No puede crear mas de 3 quinielas');						
	</script>	
...
<?php
	...
	?>	
       ...
       <!-- ---------------------------------------identificas las quinielas del usuario logeado----------------------------------------->
        ...
        <?php		
					...
					$quiniela_total=$base->prepare("select codigo_quiniela from usuarios_quiniela where cedula='$_usuario'");
					
					$quiniela_total->execute(array());
					$cantidad_quiniela = $quiniela_total->fetchAll();
					...
					<select  name='seleccion' id="seleccion1" onchange='enviar(this.value)'>
				...
				<?php 	
					...
					$i=1;
					foreach ($cantidad_quiniela as $row):
					$quiniela_seleccionada=$row["codigo_quiniela"];
					
					if($_POST["seleccion"]==$quiniela_seleccionada){
						
					?> 
                    
              		<option value="<?php echo $quiniela_seleccionada ?>" selected><?php echo $i ?></option>
                    ...
                    <option value="<?php echo $quiniela_seleccionada ?>"><?php echo $i ?></option>
					<?php 	
					}
...
//----------------------------------------------------------Espera a seleccionar una quiniela-------------------------------------------					
if(isset($_POST["seleccion"]) || (isset($_POST["actualizar"]))){
					...
					if(isset($_POST["seleccion"])){
						...
						$_SESSION["n_quiniela"]=$_POST["seleccion"];
					
					    $numero_quiniela=$_SESSION["n_quiniela"];
						...
						$valores=$base->prepare("select valor_1, valor_2 from quinielas inner join usuarios_quiniela on quinielas.codigo_quiniela=usuarios_quiniela.codigo_quiniela where quinielas.codigo_quiniela='$numero_quiniela' and quinielas.posicion='$con' and cedula='$_usuario'");
						$valores->execute(array());
	...
	if(isset($_POST["actualizar"])){
					  ...
					  $numero_quiniela=$_SESSION["n_quiniela"];
							...
							for($con=1;$con<=64;$con++){
								...
								$actualizar="update quinielas set valor_1='${'posicion'.$h.'s'}', valor_2='${'posicion'.$k.'s'}' where codigo_quiniela='$numero_quiniela' and posicion='$con'";
			...
			//--------------------------------------------recupera valores en la base de datos-----------------------------				
						...
						$valores=$base->prepare("select valor_1, valor_2 from quinielas where codigo_quiniela='$numero_quiniela' and posicion='$con'");
						$valores->execute(array());
...
if($suma_goles!=0){
	...
	for($w=1;$w<=8;$w++){
					...
					$sql_equipos = $base->prepare("select distinct equipo_1 from quinielas where grupo='$grupo' and codigo_quiniela='$numero_quiniela'");
...
//------------------------------------------------------------------------recorre los partidos---------------------------------------
					...
					$sql_partidos = $base->prepare("select equipo_1, valor_1, valor_2 from quinielas where grupo='$grupo' and codigo_quiniela='$numero_quiniela'");
...
//-------------------------------------------------------------segundo contador------------------------------------------------------	
				...
				$sql_partidos1 = $base->prepare("select equipo_2, valor_1, valor_2 from quinielas where grupo='$grupo' and codigo_quiniela='$numero_quiniela'");
...
/*//----------------------------------------------------------------------verifico si la diferencia de goles se repite-----------------
$sw1=0;
$desempate_final=array();	
$g_favor=array();	


					 $longitud=sizeof($clasificacion_final);
					
					$arreglo_vector="";
					
					for($i=0;$i<$longitud;$i++){
						
						${"paises_goles".$i}=substr($clasificacion_final[$i],strlen(intval($clasificacion_final[$i])),(strlen($clasificacion_final[$i])-strlen(intval($clasificacion_final[$i]))));
						
						${"g_favor_".$i}=intval($clasificacion_final[$i]);
						
						
						$arreglo_vector=$arreglo_vector.${"paises_goles".$i} . "=>".${"g_favor_".$i} ;
					...
					$clasificacion_puntos = array($arreglo_vector);
					
					 $longitud_2=sizeof($clasificacion_puntos);
					
					$arreglo_1=(array_count_values($clasificacion_puntos));
					
					$sw=0;

					foreach ($arreglo_1 as $val_1) {
				
					 if($val_1>1){
						 
						 echo "entreeee";
		
						 echo $sw1=1; //variable usada para saber si hay puntajes repetidos
					...
					if($sw1==1){
						...
						for($i=0;$i<$longitud;$i++){
							...
							$mystring_1=$desempate_final[$i];
							$desempate_1=$goles_marcados_array[$j];
							$findme_1=substr($desempate_1,strlen(intval($desempate_1)),(strlen($desempate_1)-strlen(intval($desempate_1))));
							
							$pos = strpos($mystring_1, $findme_1);
							
								if ($pos==true) {
										
									$g_favor[$k]=$goles_marcados_array[$j]	;								
									$k=$k+1;	   
								}								
							}						
					}	
				
						arsort($g_favor,SORT_NUMERIC);					
									
						$i=0;
								
							foreach ($g_favor as $puntaje) {
								
								echo "paises";								
								echo $g_favor[$i]=$puntaje;	
								
								
								 $i=$i+1;	
							}
						
						$primer_lugar=substr($g_favor[0],strlen(intval($g_favor[0])),(strlen($g_favor[0])-strlen(intval($g_favor[0]))));
						$segundo_lugar=substr($g_favor[1],strlen(intval($g_favor[1])),(strlen($g_favor[1])-strlen(intval($g_favor[1]))));
...
//------------------------------------------------------Inserta clasificados en la quiniela del usuario-------------------------------
							...
							for($con=49;$con<=56;$con++){
								...
								$octavos_actualizar="update quinielas set equipo_1='$equipo_1', equipo_2='$equipo_2' where codigo_quiniela='$numero_quiniela' and posicion='$con'";
...
//--------------------------------------------------comparo clasificados con los equipos de la  base de datos ---------------------
							...
							for($con=49;$con<=56;$con++){
								...
								$equipos_clasificados= $base->prepare("select equipo_1 from quinielas where codigo_quiniela='$numero_quiniela' and posicion='$con'");
								...
								$equipos_clasificados_1= $base->prepare("select equipo_2 from quinielas where 		      codigo_quiniela='$numero_quiniela' and posicion='$con'");
...
//---------------------------------------------------introducir pais indefinido en octavos----------------------------------------------
		...
		$octavos_actualizar="update quinielas set equipo_1='$pais_indefinido', equipo_2='$pais_indefinido' where codigo_quiniela='$numero_quiniela' and posicion='$con'";
...
//-------------------------------------------------------------Inserta equipos a cuartos de final-----------------------------------
	...
	for($con=57;$con<=60;$con++){
		...
		$cuartos_actualizar="update quinielas set equipo_1='$paises_cuartos[$i]', equipo_2='$paises_cuartos[$j]' where codigo_quiniela='$numero_quiniela' and posicion='$con'";
...
//-------------------------------------------------------------Inserta equipos a semifinales-----------------------------------	
	...
	for($con=61;$con<=62;$con++){
		...
		$semi_actualizar="update quinielas set equipo_1='$paises_semi[$i]', equipo_2='$paises_semi[$j]' where codigo_quiniela='$numero_quiniela' and posicion='$con'";
...
//-------------------------------------------------------------Inserta equipos a 3 lugar-----------------------------------	
	...
	for($con=63;$con<=64;$con++){
		...
		$final_actualizar="update quinielas set equipo_1='$paises_final[$i]', equipo_2='$paises_final[$j]' where codigo_quiniela='$numero_quiniela' and posicion='$con'";
...
<form name="formulario_crea_quiniela" method="post"  id="formulario_crea_quiniela">

<input type='submit' <?php comprobar()?> name="crear" id="crear" class="button1" value='Crear Quiniela'>
...
<div id="col1">
    ...
    <form name="formulario_fase_grupo" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" id="formulario_fase_grupo">
     ...
     <table id="equipos_grupo_a">
       ...
       <th id="titulo_grupo_a" colspan="6">         
        ...
        <tr id="a_partido_1">
            ...
            <td><input type="text" name="1" id="a_local_1" class="cuadro" value="<?php echo $indice1s ?>" onkeypress="return isNumberKey(this);"></td>
            <td><input type="text" name="2" id="a_visitante_1" class="cuadro" value="<?php echo $indice2s  ?>" onkeypress="return isNumberKey(this);"></td>
         ...
         <tr id="a_partido_2">
            ...
            <td><input type="text" name="3" id="a_local_2" class="cuadro" value="<?php echo $indice3s ?>" onkeypress="return isNumberKey(this);"></td>
            <td><input type="text" name="4" id="a_visitante_2" class="cuadro" value="<?php echo $indice4s  ?>" onkeypress="return isNumberKey(this);"></td>
         ...
         <tr id="a_partido_3">
            ...
            <td><p class="informacion"><strong>RUSSIA</strong></p></td>
            <td><img src="equipos mundial/png/012-russia.png" class="imagen"></td>
            <td><input type="text" name="5" id="a_local_3" class="cuadro" value="<?php echo $indice5s  ?>" onkeypress="return isNumberKey(this);"></td>
            <td><input type="text" name="6" id="a_visitante_3" class="cuadro" value="<?php echo $indice6s  ?>" onkeypress="return isNumberKey(this);"></td>
            <td><img src="equipos mundial/png/005-egypt.png" class="imagen"></td>
            <td><p class="informacion"><strong>EGIPTO</strong></p></td>
 ...
 <!-- ---------------------------------------------cuadro de octavos de final ----------------------------------------------------- -->
   ...
   <td class="colum1"><p class="informacion1"><strong><?php echo $paises_octavos[0] ?></strong></p></td>
    ...
    <td class="colum2"><input type="text" name="97"  class="cuadro" value="<?php echo $indice97s  ?>" onkeypress="return isNumberKey(this);"></td> 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="105"  class="cuadro" value="<?php echo $indice105s  ?>" onkeypress="return isNumberKey(this);"></td>
   ...
   <td class="colum1"><p class="informacion1"><strong><?php echo $paises_cuartos[0] ?></strong></p></td>
    ...
    <td class="colum2"><input type="text" name="113"  class="cuadro" value="<?php echo $indice113s  ?>" onkeypress="return isNumberKey(this);"></td>  
    ...
    <td class="colum2"><input type="text" name="117"  class="cuadro" value="<?php echo $indice117s  ?>" onkeypress="return isNumberKey(this);"></td>
  ...
  <td>&nbsp;</td>
    ...
    <td class="colum2"><input type="text" name="98"  class="cuadro" value="<?php echo $indice98s  ?>" onkeypress="return isNumberKey(this);"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
   <td class="colum2"><input type="text" name="106"  class="cuadro" value="<?php echo $indice106s  ?>" onkeypress="return isNumberKey(this);"></td>
    ...
    <td class="colum2"><input type="text" name="121"  class="cuadro" value="<?php echo $indice121s  ?>" onkeypress="return isNumberKey(this);"></td> 
     <td>&nbsp;</td>
     <td>&nbsp;</td>
     <td colspan="2" rowspan="4"><img id="copa" src="imagenes/copa_del_mundo.png" class="copa"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="123"  class="cuadro" value="<?php echo $indice123s  ?>" onkeypress="return isNumberKey(this);"></td>
   ...
   <td class="colum1"><p class="informacion1"><strong><?php echo $paises_octavos[2] ?></strong></p></td>
    ...
    <td class="colum2"><input type="text" name="99"  class="cuadro" value="<?php echo $indice99s  ?>" onkeypress="return isNumberKey(this);"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="107"  class="cuadro" value="<?php echo $indice107s  ?>" onkeypress="return isNumberKey(this);"></td>    
    ...
    <td class="colum2"><input type="text" name="114"  class="cuadro" value="<?php echo $indice114s  ?>" onkeypress="return isNumberKey(this);"></td> 
    ...
    <td class="colum2"><input type="text" name="118"  class="cuadro" value="<?php echo $indice118s  ?>" onkeypress="return isNumberKey(this);"></td>  
   ...
   <td class="colum1"><p class="informacion1"><strong><?php echo $paises_octavos[3] ?></strong></p></td>
    ...
    <td class="colum2"><input type="text" name="100"  class="cuadro" value="<?php echo $indice100s  ?>" onkeypress="return isNumberKey(this);"></td> 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="108"  class="cuadro" value="<?php echo $indice108s  ?>" onkeypress="return isNumberKey(this);"></td>    
    ...
    <td class="colum2"><input type="text" name="127"  class="cuadro" value="<?php echo $indice127s  ?>" onkeypress="return isNumberKey(this);"></td> 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
   
     <td class="colum2"><input type="text" name="128"  class="cuadro" value="<?php echo $indice128s  ?>" onkeypress="return isNumberKey(this);"></td>
   ...
   <td class="colum1"><p class="informacion1"><strong><?php echo $paises_octavos[4] ?></strong></p></td>
    ...
    <td class="colum2"><input type="text" name="101"  class="cuadro" value="<?php echo $indice101s  ?>" onkeypress="return isNumberKey(this);"></td>
   	<td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
     <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
   <td class="colum2"><input type="text" name="109"  class="cuadro" value="<?php echo $indice109s  ?>" onkeypress="return isNumberKey(this);"></td>
    ...
    <td class="colum2"><input type="text" name="115"  class="cuadro" value="<?php echo $indice115s  ?>" onkeypress="return isNumberKey(this);"></td> 
    ...
    <td>&nbsp;</td>
     ...
     <td class="colum2"><input type="text" name="119"  class="cuadro" value="<?php echo $indice119s  ?>" onkeypress="return isNumberKey(this);"></td>
   ...
   <td>&nbsp;</td>
    ...
    <td class="colum2"><input type="text" name="102"  class="cuadro" value="<?php echo $indice102s  ?>" onkeypress="return isNumberKey(this);"></td>
   <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
     <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="110"  class="cuadro" value="<?php echo $indice110s  ?>" onkeypress="return isNumberKey(this);"></td> 
    ...
    <td class="colum2"><input type="text" name="122"  class="cuadro" value="<?php echo $indice122s  ?>" onkeypress="return isNumberKey(this);"></td>   
    <td>&nbsp;</td>
     <td>&nbsp;</td>
     <td>&nbsp;</td>
     <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
	 <td class="colum2"><input type="text" name="124"  class="cuadro" value="<?php echo $indice124s  ?>" onkeypress="return isNumberKey(this);"></td>
    ...
    <td class="colum2"><input type="text" name="103"  class="cuadro" value="<?php echo $indice103s  ?>" onkeypress="return isNumberKey(this);"></td>  
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="111"  class="cuadro" value="<?php echo $indice111s  ?>" onkeypress="return isNumberKey(this);"></td>   
    ...
    <td class="colum2"><input type="text" name="116"  class="cuadro" value="<?php echo $indice116s  ?>" onkeypress="return isNumberKey(this);"></td>   
    ...
    <td class="colum2"><input type="text" name="120"  class="cuadro" value="<?php echo $indice120s  ?>" onkeypress="return isNumberKey(this);"></td>
   ...
   <td class="colum1"><p class="informacion1"><strong><?php echo $paises_octavos[7] ?></strong></p></td>    
    ...
    <td class="colum2"><input type="text" name="104"  class="cuadro" value="<?php echo $indice104s  ?>" onkeypress="return isNumberKey(this);"></td> 
   <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="112"  class="cuadro" value="<?php echo $indice112s  ?>" onkeypress="return isNumberKey(this);"></td>       
   ...
   <td>&nbsp;</td>
    ...
    <td class="colum2"><input type="text" name="125"  class="cuadro" value="<?php echo $indice125s  ?>" onkeypress="return isNumberKey(this);"></td>  
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="126"  class="cuadro" value="<?php echo $indice126s  ?>" onkeypress="return isNumberKey(this);"></td>
...
<input type="submit" <?php comprobar()?> name="actualizar" id="actualizar" class="button2" value="Actualizar">
   </form>
...
<div id="col1">
     ...
     <table id="equipos_grupo_a">
       ...
       <th id="titulo_grupo_a" colspan="6">         
        ...
        <tr id="a_partido_1">
            ...
            <td><p class="informacion"><strong>RUSSIA</strong></p></td>
            <td><img src="equipos mundial/png/012-russia.png" class="imagen"></td>
            <td><input type="text" name="a_local_1" id="a_local_1" class="cuadro" disabled></td>
            <td><input type="text" name="a_visitante_1" id="a_visitante_1" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/013-saudi-arabia.png" class="imagen"></td>
            <td><p class="informacion"><strong>ARABIA <br> SAUDITA</strong></p></td>
         ...
         <tr id="a_partido_2">
            ...
            <td><p class="informacion"><strong>EGIPTO</strong></p></td>
            <td><img src="equipos mundial/png/005-egypt.png" class="imagen"></td>
            <td><input type="text" name="a_local_2" id="a_local_2" class="cuadro" disabled></td>
            <td><input type="text" name="a_visitante_2" id="a_visitante_2" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/023-uruguay.png" class="imagen"></td>
            <td><p class="informacion"><strong>URUGUAY</strong></p></td>
         ...
         <tr id="a_partido_3">
            ...
            <td><p class="informacion"><strong>RUSSIA</strong></p></td>
            <td><img src="equipos mundial/png/012-russia.png" class="imagen"></td>
            <td><input type="text" name="a_local_3" id="a_local_3" class="cuadro" disabled></td>
            <td><input type="text" name="a_visitante_3" id="a_visitante_3" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/005-egypt.png" class="imagen"></td>
            <td><p class="informacion"><strong>EGIPTO</strong></p></td>
         ...
         <tr id="a_partido_4">
            ...
            <td><p class="informacion"><strong>URUGUAY</p></td>
            <td><img src="equipos mundial/png/023-uruguay.png" class="imagen"></td>
            <td><input type="text" name="a_local_4" id="a_local_4" class="cuadro" disabled></td>
            <td><input type="text" name="a_visitante_4" id="a_visitante_4" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/013-saudi-arabia.png" class="imagen"></td>
            <td><p class="informacion"><strong>ARABIA <br> SAUDITA</strong></p></td>
         ...
         <tr id="a_partido_5">
            ...
            <td><p class="informacion"><strong>ARABIA <br> SAUDITA</strong></p></td>
            <td><img src="equipos mundial/png/013-saudi-arabia.png" class="imagen"></td>
            <td><input type="text" name="a_local_5" id="a_local_5" class="cuadro" disabled></td>
            <td><input type="text" name="a_visitante_5" id="a_visitante_5" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/005-egypt.png" class="imagen"></td>
            <td><p class="informacion"><strong>EGIPTO</strong></p></td>
         ...
         <tr id="a_partido_6">
            ...
            <td><p class="informacion"><strong>URUGUAY</strong></p></td>
            <td><img src="equipos mundial/png/023-uruguay.png" class="imagen"></td>
            <td><input type="text" name="a_local_6" id="a_local_6" class="cuadro" disabled></td>
            <td><input type="text" name="a_visitante_6" id="a_visitante_6" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/012-russia.png" class="imagen"></td>
            <td><p class="informacion"><strong>RUSIA</strong></p></td>
     ...
     <table id="equipos_grupo_b">
       ...
       <th id="titulo_grupo_b" colspan="6">         
        ...
        <tr id="b_partido_1">
            ...
            <td><p class="informacion"><strong>MARRUECOS</strong></p></td>
            <td><img src="equipos mundial/png/019-morocco.png" class="imagen"></td>
            <td><input type="text" name="b_local_1" id="b_local_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="b_visitante_1" id="b_visitante_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/028-iran.png" class="imagen"></td>
            <td><p class="informacion"><strong>IRÁN</strong></p></td>
         ...
         <tr id="b_partido_2">
            ...
            <td><p class="informacion"><strong>PORTUGAL</strong></p></td>
            <td><img src="equipos mundial/png/011-portugal.png" class="imagen"></td>
            <td><input type="text" name="b_local_2" id="b_local_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="b_visitante_2" id="b_visitante_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/015-spain.png" class="imagen"></td>
            <td><p class="informacion"><strong>ESPAÑA</strong></p></td>
         ...
         <tr id="b_partido_3">
            ...
            <td><p class="informacion"><strong>PORTUGAL</strong></p></td>
            <td><img src="equipos mundial/png/011-portugal.png" class="imagen"></td>
            <td><input type="text" name="b_local_3" id="b_local_3" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="b_visitante_3" id="b_visitante_3" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/019-morocco.png" class="imagen"></td>
            <td><p class="informacion"><strong>MARRUECOS</strong></p></td>
         ...
         <tr id="b_partido_4">
            ...
            <td><p class="informacion"><strong>IRÁN</p></td>
            <td><img src="equipos mundial/png/028-iran.png" class="imagen"></td>
            <td><input type="text" name="b_local_4" id="b_local_4" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="b_visitante_4" id="b_visitante_4" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/015-spain.png" class="imagen"></td>
            <td><p class="informacion"><strong>ESPAÑA</strong></p></td>
         ...
         <tr id="b_partido_5">
            ...
            <td><p class="informacion"><strong>ESPAÑA</strong></p></td>
            <td><img src="equipos mundial/png/015-spain.png" class="imagen"></td>
            <td><input type="text" name="b_local_5" id="b_local_5" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="b_visitante_5" id="b_visitante_5" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/019-morocco.png" class="imagen"></td>
            <td><p class="informacion"><strong>MARRUECOS</strong></p></td>
         ...
         <tr id="b_partido_6">
            ...
            <td><p class="informacion"><strong>IRÁN</strong></p></td>
            <td><img src="equipos mundial/png/028-iran.png" class="imagen"></td>
            <td><input type="text" name="b_local_6" id="b_local_6" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="b_visitante_6" id="b_visitante_6" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/011-portugal.png" class="imagen"></td>
            <td><p class="informacion"><strong>PORTUGAL</strong></p></td>
     ...
     <table id="equipos_grupo_c">
       ...
       <th id="titulo_grupo_c" colspan="6">         
        ...
        <tr id="c_partido_1">
            ...
            <td><p class="informacion"><strong>FRANCIA</strong></p></td>
            <td><img src="equipos mundial/png/007-france.png" class="imagen"></td>
            <td><input type="text" name="c_local_1" id="c_local_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="c_visitante_1" id="c_visitante_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/024-australia.png" class="imagen"></td>
            <td><p class="informacion"><strong>AUSTRALIA</strong></p></td>
         ...
         <tr id="c_partido_2">
            ...
            <td><p class="informacion"><strong>PERU</strong></p></td>
            <td><img src="equipos mundial/png/032-peru.png" class="imagen"></td>
            <td><input type="text" name="c_local_2" id="c_local_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="c_visitante_2" id="c_visitante_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/004-denmark.png" class="imagen"></td>
            <td><p class="informacion"><strong>DINAMARCA</strong></p></td>
         ...
         <tr id="c_partido_3">
            ...
            <td><p class="informacion"><strong>FRANCIA</strong></p></td>
            <td><img src="equipos mundial/png/007-france.png" class="imagen"></td>
            <td><input type="text" name="c_local_3" id="c_local_3" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="c_visitante_3" id="c_visitante_3" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/032-peru.png" class="imagen"></td>
            <td><p class="informacion"><strong>PERU</strong></p></td>
         ...
         <tr id="c_partido_4">
            ...
            <td><p class="informacion"><strong>DINAMARCA</p></td>
            <td><img src="equipos mundial/png/004-denmark.png" class="imagen"></td>
            <td><input type="text" name="c_local_4" id="c_local_4" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="c_visitante_4" id="c_visitante_4" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/024-australia.png" class="imagen"></td>
            <td><p class="informacion"><strong>AUSTRALIA</strong></p></td>
         ...
         <tr id="c_partido_5">
            ...
            <td><p class="informacion"><strong>AUSTRALIA</strong></p></td>
            <td><img src="equipos mundial/png/024-australia.png"  class="imagen"></td>
            <td><input type="text" name="c_local_5" id="c_local_5" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="c_visitante_5" id="c_visitante_5" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/032-peru.png" class="imagen"></td>
            <td><p class="informacion"><strong>PERU</strong></p></td>
         ...
         <tr id="c_partido_6">
            ...
            <td><p class="informacion"><strong>DINAMARCA</strong></p></td>
            <td><img src="equipos mundial/png/004-denmark.png" class="imagen"></td>
            <td><input type="text" name="c_local_6" id="c_local_6" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="c_visitante_6" id="c_visitante_6" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/007-france.png" class="imagen"></td>
            <td><p class="informacion"><strong>FRANCIA</strong></p></td>
     ...
     <table id="equipos_grupo_d">
       ...
       <th id="titulo_grupo_d" colspan="6">         
        ...
        <tr id="d_partido_1">
            ...
            <td><p class="informacion"><strong>ARGENTINA</strong></p></td>
            <td><img src="equipos mundial/png/001-argentina.png" class="imagen"></td>
            <td><input type="text" name="d_local_1" id="d_local_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="d_visitante_1" id="d_visitante_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/027-iceland.png" class="imagen"></td>
            <td><p class="informacion"><strong>ISLANDIA</strong></p></td>
         ...
         <tr id="d_partido_2">
            ...
            <td><p class="informacion"><strong>CROACIA</strong></p></td>
            <td><img src="equipos mundial/png/003-croatia.png" class="imagen"></td>
            <td><input type="text" name="d_local_2" id="d_local_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="d_visitante_2" id="d_visitante_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/029-nigeria.png" class="imagen"></td>
            <td><p class="informacion"><strong>NIGERIA</strong></p></td>
         ...
         <tr id="d_partido_3">
            ...
            <td><p class="informacion"><strong>ARGENTINA</strong></p></td>
            <td><img src="equipos mundial/png/001-argentina.png" class="imagen"></td>
            <td><input type="text" name="d_local_3" id="d_local_3" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="d_visitante_3" id="d_visitante_3" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/003-croatia.png" class="imagen"></td>
            <td><p class="informacion"><strong>CROACIA</strong></p></td>
         ...
         <tr id="d_partido_4">
            ...
            <td><p class="informacion"><strong>NIGERIA</p></td>
            <td><img src="equipos mundial/png/029-nigeria.png" class="imagen"></td>
            <td><input type="text" name="d_local_4" id="d_local_4" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="d_visitante_4" id="d_visitante_4" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/027-iceland.png" class="imagen"></td>
            <td><p class="informacion"><strong>ISLANDIA</strong></p></td>
         ...
         <tr id="d_partido_5">
            ...
            <td><p class="informacion"><strong>ISLANDIA</strong></p></td>
            <td><img src="equipos mundial/png/027-iceland.png" class="imagen"></td>
            <td><input type="text" name="d_local_5" id="d_local_5" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="d_visitante_5" id="d_visitante_5" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/003-croatia.png" class="imagen"></td>
            <td><p class="informacion"><strong>CROACIA</strong></p></td>
         ...
         <tr id="d_partido_6">
            ...
            <td><p class="informacion"><strong>NIGERIA</strong></p></td>
            <td><img src="equipos mundial/png/029-nigeria.png" class="imagen"></td>
            <td><input type="text" name="d_local_6" id="d_local_6" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="d_visitante_6" id="d_visitante_6" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/001-argentina.png" class="imagen"></td>
            <td><p class="informacion"><strong>ARGENTINA</strong></p></td>
 ...
 <div id="col2">
  <div id="grupo_e">
     ...
     <table id="equipos_grupo_e">
       ...
       <th id="titulo_grupo_e" colspan="6">         
        ...
        <tr id="e_partido_1">
            ...
            <td><p class="informacion"><strong>COSTA <br> RICA</strong></p></td>
            <td><img src="equipos mundial/png/026-costa-rica.png" class="imagen"></td>
            <td><input type="text" name="e_local_1" id="e_local_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="e_visitante_1" id="e_visitante_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/021-serbia.png" class="imagen"></td>
            <td><p class="informacion"><strong>SERBIA</strong></p></td>
         ...
         <tr id="e_partido_2">
            ...
            <td><p class="informacion"><strong>BRASIL</strong></p></td>
            <td><img src="equipos mundial/png/017-brazil.png" class="imagen"></td>
            <td><input type="text" name="e_local_2" id="e_local_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="e_visitante_2" id="e_visitante_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/031-switzerland.png" class="imagen"></td>
            <td><p class="informacion"><strong>SUIZA</strong></p></td>
         ...
         <tr id="e_partido_3">
            ...
            <td><p class="informacion"><strong>BRASIL</strong></p></td>
            <td><img src="equipos mundial/png/017-brazil.png" class="imagen"></td>
            <td><input type="text" name="e_local_3" id="e_local_3" class="cuadro" disabled></td>
            <td><input type="text" name="e_visitante_3" id="e_visitante_3" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/026-costa-rica.png" class="imagen"></td>
            <td><p class="informacion"><strong>COSTA <br> RICA</strong></p></td>
         ...
         <tr id="e_partido_4">
            ...
            <td><p class="informacion"><strong>SERBIA</p></td>
            <td><img src="equipos mundial/png/021-serbia.png"  class="imagen"></td>
            <td><input type="text" name="e_local_4" id="e_local_4" class="cuadro" disabled></td>
            <td><input type="text" name="e_visitante_4" id="e_visitante_4" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/031-switzerland.png" class="imagen"></td>
            <td><p class="informacion"><strong>SUIZA</strong></p></td>
         ...
         <tr id="e_partido_5">
            ...
            <td><p class="informacion"><strong>SUIZA</strong></p></td>
            <td><img src="equipos mundial/png/031-switzerland.png" class="imagen"></td>
            <td><input type="text" name="e_local_5" id="e_local_5" class="cuadro" disabled></td>
            <td><input type="text" name="e_visitante_5" id="e_visitante_5" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/026-costa-rica.png" class="imagen"></td>
            <td><p class="informacion"><strong>COSTA <br> RICA</strong></p></td>
         ...
         <tr id="e_partido_6">
            ...
            <td><p class="informacion"><strong>SERBIA</strong></p></td>
            <td><img src="equipos mundial/png/021-serbia.png" class="imagen"></td>
            <td><input type="text" name="e_local_6" id="e_local_6" class="cuadro" disabled></td>
            <td><input type="text" name="e_visitante_6" id="e_visitante_6" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/017-brazil.png"  class="imagen"></td>
            <td><p class="informacion"><strong>BRASIL</strong></p></td>
     ...
     <table id="equipos_grupo_f">
       ...
       <th id="titulo_grupo_f" colspan="6">         
        ...
        <tr id="f_partido_1">
            ...
            <td><p class="informacion"><strong>ALEMANIA</strong></p></td>
            <td><img src="equipos mundial/png/008-germany.png" class="imagen"></td>
            <td><input type="text" name="f_local_1" id="f_local_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="f_visitante_1" id="f_visitante_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/018-mexico.png" class="imagen"></td>
            <td><p class="informacion"><strong>MEXICO</strong></p></td>
         ...
         <tr id="f_partido_2">
            ...
            <td><p class="informacion"><strong>SUECIA</strong></p></td>
            <td><img src="equipos mundial/png/016-sweden.png" class="imagen"></td>
            <td><input type="text" name="f_local_2" id="f_local_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="f_visitante_2" id="f_visitante_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/030-south-korea.png" class="imagen"></td>
            <td><p class="informacion"><strong>COREA DEL <br> SUR</strong></p></td>
         ...
         <tr id="f_partido_3">
            ...
            <td><p class="informacion"><strong>ALEMANIA</strong></p></td>
            <td><img src="equipos mundial/png/008-germany.png" class="imagen"></td>
            <td><input type="text" name="f_local_3" id="f_local_3" class="cuadro" disabled></td>
            <td><input type="text" name="f_visitante_3" id="f_visitante_3" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/016-sweden.png" class="imagen"></td>
            <td><p class="informacion"><strong>SUECIA</strong></p></td>
         ...
         <tr id="f_partido_4">
            ...
            <td><p class="informacion"><strong>COREA DEL <br> SUR</p></td>
            <td><img src="equipos mundial/png/030-south-korea.png" class="imagen"></td>
            <td><input type="text" name="f_local_4" id="f_local_4" class="cuadro" disabled></td>
            <td><input type="text" name="f_visitante_4" id="f_visitante_4" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/018-mexico.png" class="imagen"></td>
            <td><p class="informacion"><strong>MEXICO</strong></p></td>
         ...
         <tr id="f_partido_5">
            ...
            <td><p class="informacion"><strong>MEXICO</strong></p></td>
            <td><img src="equipos mundial/png/018-mexico.png" class="imagen"></td>
            <td><input type="text" name="f_local_5" id="f_local_5" class="cuadro" disabled></td>
            <td><input type="text" name="f_visitante_5" id="f_visitante_5" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/016-sweden.png" class="imagen"></td>
            <td><p class="informacion"><strong>SUECIA</strong></p></td>
         ...
         <tr id="f_partido_6">
            ...
            <td><p class="informacion"><strong>COREA DEL <br> SUR</strong></p></td>
            <td><img src="equipos mundial/png/030-south-korea.png" class="imagen"></td>
            <td><input type="text" name="f_local_6" id="f_local_6" class="cuadro" disabled></td>
            <td><input type="text" name="f_visitante_6" id="f_visitante_6" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/008-germany.png" class="imagen"></td>
            <td><p class="informacion"><strong>ALEMANIA</strong></p></td>
     ...
     <table id="equipos_grupo_g">
       ...
       <th id="titulo_grupo_g" colspan="6">         
        ...
        <tr id="g_partido_1">
            ...
            <td><p class="informacion"><strong>BÉLGICA</strong></p></td>
            <td><img src="equipos mundial/png/002-belgium.png" class="imagen"></td>
            <td><input type="text" name="g_local_1" id="g_local_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="g_visitante_1" id="g_visitante_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/020-panama.png" class="imagen"></td>
            <td><p class="informacion"><strong>PÁNAMA</strong></p></td>
         ...
         <tr id="g_partido_2">
            ...
            <td><p class="informacion"><strong>TÚNEZ</strong></p></td>
            <td><img src="equipos mundial/png/022-turkey.png" class="imagen"></td>
            <td><input type="text" name="g_local_2" id="g_local_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="g_visitante_2" id="g_visitante_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/006-england.png" class="imagen"></td>
            <td><p class="informacion"><strong>INGLATERRA</strong></p></td>
         ...
         <tr id="g_partido_3">
            ...
            <td><p class="informacion"><strong>BÉLGICA</strong></p></td>
            <td><img src="equipos mundial/png/002-belgium.png" class="imagen"></td>
            <td><input type="text" name="g_local_3" id="g_local_3" class="cuadro" disabled></td>
            <td><input type="text" name="g_visitante_3" id="g_visitante_3" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/022-turkey.png" class="imagen"></td>
            <td><p class="informacion"><strong>TÚNEZ</strong></p></td>
         ...
         <tr id="g_partido_4">
            ...
            <td><p class="informacion"><strong>INGLATERRA</p></td>
            <td><img src="equipos mundial/png/006-england.png" class="imagen"></td>
            <td><input type="text" name="g_local_4" id="g_local_4" class="cuadro" disabled></td>
            <td><input type="text" name="g_visitante_4" id="g_visitante_4" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/020-panama.png" class="imagen"></td>
            <td><p class="informacion"><strong>PÁNAMA</strong></p></td>
         ...
         <tr id="g_partido_5">
            ...
            <td><p class="informacion"><strong>PÁNAMA</strong></p></td>
            <td><img src="equipos mundial/png/020-panama.png" class="imagen"></td>
            <td><input type="text" name="g_local_5" id="g_local_5" class="cuadro" disabled></td>
            <td><input type="text" name="g_visitante_5" id="g_visitante_5" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/022-turkey.png" class="imagen"></td>
            <td><p class="informacion"><strong>TÚNEZ</strong></p></td>
         ...
         <tr id="g_partido_6">
            ...
            <td><p class="informacion"><strong>INGLATERRA</strong></p></td>
            <td><img src="equipos mundial/png/006-england.png" class="imagen"></td>
            <td><input type="text" name="g_local_6" id="g_local_6" class="cuadro" disabled></td>
            <td><input type="text" name="g_visitante_6" id="g_visitante_6" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/002-belgium.png" class="imagen"></td>
            <td><p class="informacion"><strong>BÉLGICA</strong></p></td>
     ...
     <table id="equipos_grupo_h">
       ...
       <th id="titulo_grupo_h" colspan="6">         
        ...
        <tr id="h_partido_1">
            ...
            <td><p class="informacion"><strong>POLONIA</strong></p></td>
            <td><img src="equipos mundial/png/010-poland.png" class="imagen"></td>
            <td><input type="text" name="h_local_1" id="h_local_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="h_visitante_1" id="h_visitante_1" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/014-senegal.png" class="imagen"></td>
            <td><p class="informacion"><strong>SENEGAL</strong></p></td>
         ...
         <tr id="h_partido_2">
            ...
            <td><p class="informacion"><strong>COLOMBIA</strong></p></td>
            <td><img src="equipos mundial/png/025-colombia.png" class="imagen"></td>
            <td><input type="text" name="h_local_2" id="h_local_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><input type="text" name="h_visitante_2" id="h_visitante_2" class="cuadro" form="formulario_fase_grupo" disabled></td>
            <td><img src="equipos mundial/png/009-japan.png" class="imagen"></td>
            <td><p class="informacion"><strong>JAPÓN</strong></p></td>
         ...
         <tr id="h_partido_3">
            ...
            <td><p class="informacion"><strong>JAPÓN</strong></p></td>
            <td><img src="equipos mundial/png/009-japan.png" class="imagen"></td>
            <td><input type="text" name="h_local_3" id="h_local_3" class="cuadro" disabled></td>
            <td><input type="text" name="h_visitante_3" id="h_visitante_3" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/014-senegal.png" class="imagen"></td>
            <td><p class="informacion"><strong>SENEGAL</strong></p></td>
         ...
         <tr id="h_partido_4">
            ...
            <td><p class="informacion"><strong>POLONIA</p></td>
            <td><img src="equipos mundial/png/010-poland.png" class="imagen"></td>
            <td><input type="text" name="h_local_4" id="h_local_4" class="cuadro" disabled></td>
            <td><input type="text" name="h_visitante_4" id="h_visitante_4" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/025-colombia.png" class="imagen"></td>
            <td><p class="informacion"><strong>COLOMBIA</strong></p></td>
         ...
         <tr id="h_partido_5">
            ...
            <td><p class="informacion"><strong>SENEGAL</strong></p></td>
            <td><img src="equipos mundial/png/014-senegal.png" class="imagen"></td>
            <td><input type="text" name="h_local_5" id="h_local_5" class="cuadro" disabled></td>
            <td><input type="text" name="h_visitante_5" id="h_visitante_5" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/025-colombia.png" class="imagen"></td>
            <td><p class="informacion"><strong>COLOMBIA</strong></p></td>
         ...
         <tr id="h_partido_6">
            ...
            <td><p class="informacion"><strong>JAPÓN</strong></p></td>
            <td><img src="equipos mundial/png/009-japan.png" class="imagen"></td>
            <td><input type="text" name="h_local_6" id="h_local_6" class="cuadro" disabled></td>
            <td><input type="text" name="h_visitante_6" id="h_visitante_6" class="cuadro" disabled></td>
            <td><img src="equipos mundial/png/010-poland.png" class="imagen"></td>
            <td><p class="informacion"><strong>POLONIA</strong></p></td>
   ...
   <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="97"  class="cuadro " onkeypress="return isNumberKey(this);" disabled></td> 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="105"  class="cuadro "  onkeypress="return isNumberKey(this);" disabled></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>  
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png"class="imagen"></td>
    <td class="colum2"><input type="text" name="113"  class="cuadro "  onkeypress="return isNumberKey(this);" disabled></td>    
    ...
    <td>&nbsp;</td>
     ...
     <td class="colum2"><input type="text" name="117"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
  <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
  <td>&nbsp;</td>
     <td >&nbsp;</td>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="98"  class="cuadro"  onkeypress="return isNumberKey(this);" disabled></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="106"  class="cuadro"   onkeypress="return isNumberKey(this);" disabled></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td  class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td  class="colum2"><input type="text" name="121"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>
     <td>&nbsp;</td>
     <td>&nbsp;</td>
     <td colspan="2" rowspan="4"><img id="copa" src="imagenes/copa_del_mundo.png" class="copa"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td  class="colum2"><input type="text" name="107"  class="cuadro"   onkeypress="return isNumberKey(this);" disabled></td>    
    <td  class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td  class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
     <td>&nbsp;</td>
    <td>&nbsp;</td>
   ...
   <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="99"  class="cuadro"  onkeypress="return isNumberKey(this);" disabled></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="114"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>
    ...
    <td class="colum2"><input type="text" name="118"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>  
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
 	<td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td> 
    <td>&nbsp;</td>  
    <td >&nbsp;</td>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="100"  class="cuadro " onkeypress="return isNumberKey(this);" disabled></td> 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="108"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>    
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    ...
    <td>&nbsp;</td>
     ...
     <td>&nbsp;</td>
     <td>&nbsp;</td>
     <!--<td  rowspan="3" colspan="3"><img width="100" src="../copa13.png" class="imagen_campeon"></td>-->
    ...
    <td>&nbsp;</td>
     ...
     <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td  class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td  class="colum2"><input type="text" name="127"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
   
     <td class="colum2"><input type="text" name="128"  class="cuadro "  onkeypress="return isNumberKey(this);" disabled></td>
    <td  class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td  class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td> 
    <td>&nbsp;</td>
     <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
     ...
     <td>&nbsp;</td>
       <td>&nbsp;</td>
        <td>&nbsp;</td>     
     <td colspan="2"><p class="final"><strong>Campeon</strong><br><img id="campeon" src="equipos mundial/png/sin_definir.png" class="imagen_campeon"></p></td>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="101"  class="cuadro "  onkeypress="return isNumberKey(this);" disabled></td>
   	<td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
     <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
   <td class="colum2"><input type="text" name="109"  class="cuadro "  onkeypress="return isNumberKey(this);" disabled></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    </tr>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="115"  class="cuadro "  onkeypress="return isNumberKey(this);" disabled></td>  
    ...
    <td>&nbsp;</td>
     ...
     <td class="colum2"><input type="text" name="119"  class="cuadro"  onkeypress="return isNumberKey(this);" disabled></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>  
   <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
   <td>&nbsp;</td>
     <td >&nbsp;</td>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="102"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>
   <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
     <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
     <td class="colum2"><input type="text" name="110"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td> 
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
	...
	<td  class="colum2"><input type="text" name="119"  class="cuadro"  onkeypress="return isNumberKey(this);" disabled></td>
    <td  class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>  
   <td  class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>     <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>    
     <td >&nbsp;</td>
    <td >&nbsp;</td>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="103"  class="cuadro" onkeypress="return isNumberKey(this);" disabled></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="111"  class="cuadro"   onkeypress="return isNumberKey(this);" disabled></td>   
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td> 
    ...
    <td >&nbsp;</td>
     ...
     <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="116"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>
    ...
    <td class="colum2"><input type="text" name="120"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
   <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
     <td >&nbsp;</td>
    <td >&nbsp;</td>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td> 
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum2"><input type="text" name="104"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>    
   <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="112"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
   ...
   <td>&nbsp;</td>
    ...
    <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td> 
    <td class="colum2"><input type="text" name="125"  class="cuadro"   onkeypress="return isNumberKey(this);" disabled></td> 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="colum2"><input type="text" name="126"  class="cuadro "   onkeypress="return isNumberKey(this);" disabled></td>
    <td class="colum1"><img src="equipos mundial/png/sin_definir.png" class="imagen"></td>
   <td class="colum1"><p class="informacion1"><strong>UNAVARIABLE</strong></p></td>
