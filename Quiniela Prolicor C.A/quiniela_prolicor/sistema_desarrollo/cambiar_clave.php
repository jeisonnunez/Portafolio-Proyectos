...
if(!isset($_SESSION)){
	...
	if(!isset($_SESSION["login"])){
		...
		header("location:sistema_login/login_encriptado.php");	
...
<div class="testbox">
  ...
  <form action="sistema_login/cambio_clave.php" method="post" name="formulario_registro" id="formulario_registro">
      <hr>
   

 
  
   <label id="icon" for="p_usu"><i class="icon-envelope "></i></label>
  <input type="password" class="focus" name="p_usu"   placeholder="Clave" required/>
