...
<div class="testbox">
  ...
  <form action="resultado_insertar_registros.php" method="post" name="formulario_registro" id="formulario_registro">
      <hr>
  ...
  <label id="icon" for="p_usu"><i class="icon-shield"></i></label>
  <input type="password" class="focus" name="p_usu"  placeholder="Password" required/>
  
   <p>Al hacer click acepta los terminos y servicio.</p>
