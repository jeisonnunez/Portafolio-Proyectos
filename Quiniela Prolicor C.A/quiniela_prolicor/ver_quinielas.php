...
<img id="logo" src="imagenes/prolicor_logo1.png"><h1 id="titulo">QUINIELA PROLICOR NUBE AZUL</h1> <img id="logo1" src="imagenes/logo_nb.png">    
 ...
 <p class='usuario'>Administrador: <?php echo $_SESSION["usuario"] ?> </p><br>
 
 
<?php

//------------------------------------------------recupero el codigo de quiniela del usuario-------------------------------------------

$codigo_quiniela=$_POST['codigo'];

						$i_usuario=$base->prepare("select cedula from usuarios_quiniela where codigo_quiniela='$codigo_quiniela'");

						$i_usuario->execute(array());
						
						$cedula = $i_usuario->fetchAll();
...
<p class='usuario'>Quiniela: <?php echo $codigo_quiniela ?> </p><br>	
<p class='usuario'>Usuario: <?php echo $usuario ?> </p>						


<?php 
//---------------------------------------------------recupero valores de la quiniela seleccionada---------------------------------------
						...
						$valores=$base->prepare("select valor_1, valor_2 from quinielas where posicion='$con' and codigo_quiniela='$codigo_quiniela'");
...
//------------------------------------------------------octavos de final s---------------------------------------------------
							...
							$paises=$base->prepare("select equipo_1, equipo_2 from quinielas where posicion='$con' and codigo_quiniela='$codigo_quiniela'");
	...
	//---------------------------------------------------cuartos------------------------------------------------------------------					
						for($con=57;$con<=60;$con++){
							...
							$paises_cuartos_1=$base->prepare("select equipo_1, equipo_2 from quinielas where posicion='$con' and codigo_quiniela='$codigo_quiniela'");
		...
		//------------------------------------------------semi---------------------------------------------------------------------	
					...
					for($con=61;$con<=62;$con++){
							...
							$paises_semi_1=$base->prepare("select equipo_1, equipo_2 from quinielas where posicion='$con' and codigo_quiniela='$codigo_quiniela'");
...
//-----------------------------------------------------------------final-------------------------------------------------------
				...
				for($con=63;$con<=64;$con++){
							...
							$paises_final_1=$base->prepare("select equipo_1, equipo_2 from quinielas where posicion='$con' and codigo_quiniela='$codigo_quiniela'");
...
<div id="col1">
 ...
 <a href="quinielas_usuarios.php"><input type="button" class="button" value="Volver"></a>
