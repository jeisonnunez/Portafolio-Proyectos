...
{
public:
	CSboBusinessObjectBase (unsigned long lSystemHandle){m_lSystemHandle = lSystemHandle;};
...
//protected:							
	...
	virtual SBOErr					OnYearTransfer (unsigned long lCompanyRef) = 0;

	virtual	CSboBusinessObjectBase	*Clone (unsigned long lSystemHandle) = 0;
	virtual	void					Destroy () = 0;
	long							m_lSystemHandle;
...
//	friend class CUdoBusinessObject;
};
