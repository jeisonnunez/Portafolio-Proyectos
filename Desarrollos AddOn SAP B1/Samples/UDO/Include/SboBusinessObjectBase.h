...
{
public:
	CSboBusinessObjectBase (uintptr_t lSystemHandle){m_lSystemHandle = lSystemHandle;};
...
//protected:							
	...
	virtual SBOErr					OnCanArchive (const wchar_t* archivePeriod, const unsigned long lResRef) = 0;
