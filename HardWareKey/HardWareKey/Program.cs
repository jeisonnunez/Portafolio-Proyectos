    ...
    class Program
    {
        ...
        private static async Task<string> ReturnHardWareID()
        {
            ...
            Task task = Task.Run(() =>
            {
                ...
                string _id = string.Concat("SCV_SYSTEM", GetProcessorId(), GetMotherboardID(), GetDiskVolumeSerialNumber());
            ...
            hashesByte = System.Security.Cryptography.SHA256.Create().ComputeHash(bytes);
